from sqlalchemy import ForeignKey, Table, Integer, Column, func, String,TIMESTAMP
...
follower_tbl = Table("followers_tbl",
                  Base.metadata,
...
class User(Base):
    ...
    likes = relationship("Like",back_populates="users_lk", cascade="all, delete-orphan")
...
class Like(Base):
    ...
    users_lk : Mapped["User"] = relationship("User", back_populates="likes",lazy="joined")
