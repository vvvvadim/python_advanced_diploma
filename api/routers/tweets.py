...
@tweets_router.delete("/api/tweets/{tweet_id}",
                      status_code=status.HTTP_200_OK,
                      response_model=MSG,
                      name="Удаление твита",
...
@tweets_router.post("/api/tweets/{tweet_id}/likes",
                    status_code=status.HTTP_200_OK,
                    response_model=MSG,
...
@tweets_router.delete("/api/tweets/{tweet_id}/likes",
                      status_code=status.HTTP_200_OK,
                      response_model=MSG,
