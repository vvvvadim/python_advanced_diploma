...
from api.config.schemas import GetUser, MSG
from api.function.user_func import get_user_by_id, user_follow, user_unfollow,get_user_by_token
...
@user_router.post("/api/users/{user_id}/follow",
                  status_code=status.HTTP_200_OK,
                  response_model=MSG,
...
@user_router.delete("/api/users/{user_id}/follow",
                    status_code=status.HTTP_200_OK,
                    response_model=MSG,
